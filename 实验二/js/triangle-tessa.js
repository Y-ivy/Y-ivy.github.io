...
function initTriangles() {
  ...
  numTimesToSubdivide=document.getElementById("text5").value;
  ...
  var vertices = [
    radius * Math.cos((90 * Math.PI) / 180.0),
    radius * Math.sin((90 * Math.PI) / 180.0),
    0,
    radius * Math.cos((210 * Math.PI) / 180.0),
    radius * Math.sin((210 * Math.PI) / 180.0),
    0,
    radius * Math.cos((-30 * Math.PI) / 180.0),
    radius * Math.sin((-30 * Math.PI) / 180.0),
    0,
  ];
